...
int disasters_rec(){
    ...
    if(ch==1){
        ...
        FILE* hfile = fopen("fire_data.csv", "a");
        ...
        printf("\nEnter your Address: ");
        scanf(" %100[^\n]*c", &add);
        printf("\n\n-----------------------------------------\n%s | %s | %d:%d | %02d-%02d-%04d | %s\n-----------------------------------------\n",name,city,dt.hour,dt.minute,dt.day,dt.month,dt.year,add);
